...
export default function Footer() {
  ...
  // const [, setSubscribeStatus] = useState<null | 'success' | 'error'>(null);
        ...
        <div className="pt-24 pb-12">
          <div className="grid gap-y-10 gap-x-8 md:grid-cols-2 lg:grid-cols-12">
            ...
            <div className="lg:col-span-5 md:col-span-1 font-bricolage">
              <a
                href="#"
                className="inline-block mb-6 text-3xl font-bold text-gray-800 dark:text-gray-200"
              >
                Muhammad<TextSpan>BayuAji</TextSpan>
              </a>
              <p className="mb-8 text-gray-600 dark:text-gray-400">
                Membangun pengalaman digital yang memukau dengan solusi web
                modern dan inovatif yang mengedepankan performa dan estetika.
              </p>
                  ...
                  {footerSections.pages.map((link) => {
                    ...
                    const scrollToSection = (
                      ...
                      const navbarHeight = navbarEl
                        ? (navbarEl as HTMLElement).offsetHeight
                        : 0;
                      const offsetTop =
                    ...
                    return (
                      <li key={link.name}>
                        ...
                        >
                          <svg
                            className="w-3 h-3 mr-2 text-blue-600 dark:text-blue-400"
                            fill="currentColor"
                            viewBox="0 0 20 20"
                          >
                            <path
